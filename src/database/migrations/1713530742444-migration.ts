...
export class Migration1713530742444 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "adresses" RENAME COLUMN "additionalDetails" TO "additional_details"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "clients" ADD "first_name" character varying(255) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "clients" ADD "last_name" character varying(255) NOT NULL`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "clients" ADD "firstName" character varying(255) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "adresses" RENAME COLUMN "additional_details" TO "additionalDetails"`,
    );
  }
}
